...
add_action('admin_notices', function() {
    ...
    if ( class_exists( '\Blockera\NameUtils\NameFormatter' ) ) {
        ...
        $formatted = \Blockera\NameUtils\NameFormatter::format( 'Plugin B User' );
        
        printf(
            '<div class="notice notice-success is-dismissible">
                <p><strong>Plugin B:</strong> Class loaded - v%s from %s<br>
        ...
        printf(
            '<div class="notice notice-warning is-dismissible">
                <p><strong>Plugin B:</strong> <code>NameFormatter</code> class not found!</p>
            </div>'
        );
    }
